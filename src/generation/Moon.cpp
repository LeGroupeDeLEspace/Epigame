...
Moon::Moon(std::string name, UniversalPosition position, Coordinates localPosition, float size) : CelestialBody(name, position, localPosition, size), rand(FNV1::Hash( // Generating the SolarSystem seed
